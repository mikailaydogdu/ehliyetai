/**
 * veri.json'dan dönüştürülen sorular – mock data'ya eklenir.
...
const veriJson = require('./veri.json') as VeriItem[];

export const veriSorulari: RawQuestion[] = veriJson.map((item) => {
